...
public:
    ...
    Rental createRentalFor(int daysRented, ENUM_PRICE_CODE priceCode)
    {
...
{
    customer.addRental(createRentalFor(2, ePC_REGULAR));
...
{
    customer.addRental(createRentalFor(3, ePC_REGULAR));
...
{
    customer.addRental(createRentalFor(1, ePC_NEW_RELEASE));
...
{
    customer.addRental(createRentalFor(4, ePC_CHILDRENS));
...
{
    customer.addRental(createRentalFor(3, ePC_CHILDRENS));
...
{
    customer.addRental(createRentalFor(2, ePC_NEW_RELEASE));
...
{
    Movie regularMovie = Movie(TITLE, ePC_REGULAR);
    Movie newReleaseMovie = Movie(TITLE, ePC_NEW_RELEASE);
    Movie childrensMovie = Movie(TITLE, ePC_CHILDRENS);
